...
use function TenupTheme\get_colors;
use function TenupTheme\adjust_brightness;
if ( ! defined( 'ABSPATH' ) ) {
	...
	<div class="uikit__content">
		...
		<section class="uikit__section" id="headings">
			...
			<div class="content">
				...
				<h3>H3, Heading 3 {32px}</h3>
				<h4>H4, Heading 4 {24px}</h4>
				<h5>H5, Heading 5 {24px}</h5>
			</div><!--/.content-->
		...
		<section class="uikit__section" id="body">
			...
			<div class="content">
				<p>
					20px, Satoshi, line 30 ( 150% ). Lorem ipsum dolor sit amet,
